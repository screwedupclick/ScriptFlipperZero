...
# Simuler le vol de cookies de session
keyboard_layout.write("echo 'Simulation : Vos cookies de session auraient pu être volés, donnant accès à vos comptes en ligne.'")
keyboard.send(Keycode.ENTER)